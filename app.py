...
def Header(name, app):
    ...
    logo = html.Img(
        src=app.get_asset_url("drdc-logo.png"), style={"float": "right", "height": 60}
    )
    return dbc.Row([dbc.Col(title, md=8), dbc.Col(logo, md=4)])


def textbox(text, box="AI", name="Justin Trudeau"):
    ...
    if box == "user":
        ...
        thumbnail = html.Img(
            src=app.get_asset_url("caf-logo.jpg"),
            style={
                "border-radius": 50,
                "height": 36,
                "margin-right": 5,
...
#"""
description="""
You are Justin Bieber. You don't like talking to your fans.  
"""
...
# Load images
IMAGES = {"HarmlessAI": app.get_asset_url("caf-logo.jpg")}
